...
import ImageCropModal from './ImageCropModel';
                                ...
                                <div className="card-body">
                                    <div className="d-flex flex-column align-items-center text-center">
                                        {imgloading ? (
                                            <div className="position-relative" style={{ width: '110px' }}>
                                                <img src={studentProfileData.imagepath || profileImage} alt="Admin" className="rounded-circle p-1 bg-primary" width="110" style={{ objectFit: 'cover', maxWidth: '100%', maxHeight: '100%' }} />
                                        ...
                                        <div className="mt-1">
                                            ...
                                            <p className="text-secondary mb-1">{studentProfileData.role}</p>
                                        </div>
                                    </div>
                                    ...
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <span className="text-secondary">{studentSubcriptions.length}</span>
                                        </li>
                                        ...
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <span className="text-secondary">{studenttestresult.length}</span>
                                        </li>
                                        ...
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <span className="text-secondary">{passedTestsCount}</span>
                                        </li>
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 className="mb-0 d-flex align-items-center">
                                            ...
                                            <span className="text-secondary">{failedTestsCount}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
